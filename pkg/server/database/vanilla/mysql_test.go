...
import (
	...
	mysql "github.com/claion-org/claiflow/pkg/server/database/vanilla/excute/dialects/mysql"
...
func TestGetCluster(t *testing.T) {
	const (
		dialect    = "mysql"
		connstring = "flow:flow@tcp(127.0.0.1:3306)/flow?charset=utf8mb4&parseTime=True&loc=Local"
	)
	var db *sql.DB
