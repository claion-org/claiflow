...
func (c *Client) ResourcePatch(gv schema.GroupVersion, resource string, params map[string]interface{}) (string, error) {
	...
	case "v1":
		...
		case "events":
			result, err = c.client.CoreV1().Events(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "namespaces":
		...
		case "nodes":
			result, err = c.client.CoreV1().Nodes().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		...
		case "pods":
			result, err = c.client.CoreV1().Pods(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "secrets":
		...
		case "limitranges":
			result, err = c.client.CoreV1().LimitRanges(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "podtemplates":
			result, err = c.client.CoreV1().PodTemplates(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "replicationcontrollers":
			result, err = c.client.CoreV1().ReplicationControllers(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "resourcequotas":
			result, err = c.client.CoreV1().ResourceQuotas(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "serviceaccounts":
			result, err = c.client.CoreV1().ServiceAccounts(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "apps/v1":
		...
		case "replicasets":
			result, err = c.client.AppsV1().ReplicaSets(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "statefulsets":
		...
		case "controllerrevisions":
			result, err = c.client.AppsV1().ControllerRevisions(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "networking.k8s.io/v1":
		...
		case "ingressclasses":
			result, err = c.client.NetworkingV1().IngressClasses().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "networkpolicies":
			result, err = c.client.NetworkingV1().NetworkPolicies(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "storage.k8s.io/v1":
		switch resource {
		case "storageclasses":
			result, err = c.client.StorageV1().StorageClasses().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "csidrivers":
			result, err = c.client.StorageV1().CSIDrivers().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "csinodes":
			result, err = c.client.StorageV1().CSINodes().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "csistoragecapacities":
			result, err = c.client.StorageV1().CSIStorageCapacities(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "volumeattachments":
			result, err = c.client.StorageV1().VolumeAttachments().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "batch/v1":
		...
		case "jobs":
			result, err = c.client.BatchV1().Jobs(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "admissionregistration.k8s.io/v1":
		...
		case "mutatingwebhookconfigurations":
			result, err = c.client.AdmissionregistrationV1().MutatingWebhookConfigurations().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		case "validatingwebhookconfigurations":
			result, err = c.client.AdmissionregistrationV1().ValidatingWebhookConfigurations().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "apiextensions.k8s.io/v1":
		...
		case "customresourcedefinitions":
			result, err = c.apiextv1client.ApiextensionsV1().CustomResourceDefinitions().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "apiregistration.k8s.io/v1":
		switch resource {
		case "apiservices":
			result, err = c.aggrev1client.ApiregistrationV1().APIServices().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "certificates.k8s.io/v1":
		...
		case "certificatesigningrequests":
			result, err = c.client.CertificatesV1().CertificateSigningRequests().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "coordination.k8s.io/v1":
		switch resource {
		case "leases":
			result, err = c.client.CoordinationV1().Leases(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "discovery.k8s.io/v1":
		switch resource {
		case "endpointslices":
			result, err = c.client.DiscoveryV1().EndpointSlices(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "node.k8s.io/v1":
		switch resource {
		case "runtimeclasses":
			result, err = c.client.NodeV1().RuntimeClasses().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "policy/v1":
		...
		case "poddisruptionbudgets":
			result, err = c.client.PolicyV1().PodDisruptionBudgets(namespace).Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
	...
	case "scheduling.k8s.io/v1":
		...
		case "priorityclasses":
			result, err = c.client.SchedulingV1().PriorityClasses().Patch(ctx, name, pt, data, metav1.PatchOptions{})
			if err != nil {
				break
			}
		default:
